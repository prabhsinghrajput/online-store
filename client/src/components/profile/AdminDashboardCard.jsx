...
const AdminDashboardCard = ({ isAdmin }) => {
  ...
  return (
    <div className="rounded-3xl bg-gradient-to-r from-amber-50/50 to-orange-50/50 dark:from-amber-955/5 dark:to-orange-955/5 border border-amber-100 dark:border-amber-900/10 p-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-455 dark:text-neutral-500">Manage products & orders</p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          onClick={() => navigate('/admin/products')}
          className="flex items-center justify-between p-4 bg-white dark:bg-zinc-955 hover:bg-amber-50/20 dark:hover:bg-amber-955/5 border border-gray-150 dark:border-neutral-900 rounded-2xl transition-all duration-300 hover:shadow-sm group text-left"
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-amber-50 dark:bg-amber-955/10 rounded-xl flex items-center justify-center">
