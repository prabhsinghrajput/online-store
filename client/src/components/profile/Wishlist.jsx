    ...
    <div className="w-full space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-neutral-400 mt-1">{items.length} item{items.length !== 1 ? 's' : ''} saved</p>
          </div>
        </div>

        {/* Content */}
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-zinc-900 rounded-3xl border border-gray-100 dark:border-neutral-900 shadow-sm">
            ...
            <p className="text-gray-500 dark:text-neutral-500 text-center max-w-sm mb-8">
