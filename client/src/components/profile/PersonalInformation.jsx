    ...
    <div className="bg-white dark:bg-zinc-955 border border-gray-200 dark:border-neutral-900 rounded-3xl shadow-sm dark:shadow-none overflow-hidden">
      <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-neutral-900">
        <div>
          ...
          <p className="text-xs text-gray-455 dark:text-neutral-500 mt-0.5">Manage your account details</p>
        </div>
        {!isEditing ? (
          <button
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-gray-550 dark:text-neutral-450 bg-gray-100 dark:bg-neutral-900 hover:bg-gray-200 dark:hover:bg-neutral-800 rounded-xl transition-colors"
          >
            <X size={12} />
            Cancel
          </button>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={!isEditing}
                className="w-full pl-11 pr-4 py-3 bg-transparent border border-gray-200 dark:border-neutral-800 rounded-xl text-xs font-semibold focus:ring-0 focus:border-black dark:focus:border-white focus:outline-none disabled:bg-gray-50/50 dark:disabled:bg-zinc-900/20 disabled:text-gray-450 dark:disabled:text-neutral-500 transition-all"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled
                className="w-full pl-11 pr-20 py-3 border border-gray-200 dark:border-neutral-800 rounded-xl text-xs font-semibold bg-gray-50/50 dark:bg-zinc-900/20 text-gray-455 dark:text-neutral-550 cursor-not-allowed"
              />
              <span className="absolute right-3.5 top-1/2 -translate-y-1/2 px-2 py-0.5 bg-gray-150 dark:bg-neutral-800 rounded text-[9px] font-black tracking-wider text-gray-500 dark:text-neutral-400 uppercase">
                Verified
              </span>
            </div>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <textarea
              ...
              disabled={!isEditing}
              className="w-full pl-11 pr-4 py-3 bg-transparent border border-gray-200 dark:border-neutral-800 rounded-xl text-xs font-semibold focus:ring-0 focus:border-black dark:focus:border-white focus:outline-none disabled:bg-gray-50/50 dark:disabled:bg-zinc-900/20 disabled:text-gray-455 dark:disabled:text-neutral-500 transition-all resize-none"
              rows="3"
